...
export default function WhatToWearGuide() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: t('footer.guides.whatToWear'), item: 'https://atmosmind.app/guides/what-to-wear' },
    ],
  };
  ...
  return (
    ...
    >
      <Seo
        title={t('guides.whatToWear.seoTitle')}
        description={t('guides.whatToWear.seoDescription')}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-10 sm:px-5 md:px-8 lg:px-12">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-semibold text-white/90 font-heading mb-6">
            {t('guides.whatToWear.title')}
          </h1>

          <div className="space-y-6 text-white/75 leading-8">
            <p>{t('guides.whatToWear.p1')}</p>
            <p>{t('guides.whatToWear.p2')}</p>
            <p>{t('guides.whatToWear.p3')}</p>
            <p>{t('guides.whatToWear.p4')}</p>
            <p>{t('guides.whatToWear.p5')}</p>
          </div>
        </motion.main>
      </div>
    </div>
