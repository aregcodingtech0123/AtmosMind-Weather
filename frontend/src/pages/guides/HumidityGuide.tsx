...
export default function HumidityGuide() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: t('footer.guides.humidity'), item: 'https://atmosmind.app/guides/humidity' },
    ],
  };
  ...
  return (
    ...
    >
      <Seo
        title={t('guides.humidity.seoTitle')}
        description={t('guides.humidity.seoDescription')}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-10 sm:px-5 md:px-8 lg:px-12">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-semibold text-white/90 font-heading mb-6">
            {t('guides.humidity.title')}
          </h1>

          <div className="space-y-6 text-white/75 leading-8">
            <p>{t('guides.humidity.p1')}</p>
            <p>{t('guides.humidity.p2')}</p>
            <p>{t('guides.humidity.p3')}</p>
            <p>{t('guides.humidity.p4')}</p>
            <p>{t('guides.humidity.p5')}</p>
          </div>
        </motion.main>
      </div>
    </div>
